...
- Added desktop startup logging to `%APPDATA%\Planix\logs\desktop.log`.
...
- `Planix-v1.1.1-windows-x64.msi`
- `Planix-v1.1.1-windows-x64.sha256`

## Notes

Normal users should download the MSI installer only. Do not use Source code.zip as the installer, and do not run `planix-api.exe` manually.
