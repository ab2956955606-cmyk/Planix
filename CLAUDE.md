...
- Phase 4.9A is not the task-level Multi-Model Router phase. Do not add provider fallback chains, multi-key settings, WriteIntent/Undo, or direct memory-to-plan writes while adding the internal ModelProvider layer.
